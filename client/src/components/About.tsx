    ...
    <section id="about" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl">
          <h2 className="text-4xl font-bold mb-6 text-center text-foreground bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">{t("about.heading")}</h2>
          <div className="rounded-2xl overflow-hidden shadow-xl bg-card border border-gray-800 p-8 mb-12">
          ...
          <div className="rounded-2xl overflow-hidden shadow-xl bg-card border border-gray-800 p-8">
            <h3 className="text-2xl font-bold mb-6 text-center text-foreground">{t("about.team")}</h3>
